...
import com.esaudev.gamesgarden.util.bouncy.Bouncy
import com.esaudev.gamesgarden.util.bouncy.BouncyEdgeEffect
...
class NewNestedScroll @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    ScrollingView
{
    ...
    {
        fun onScrollChange(v: NewNestedScroll?, scrollX: Int, scrollY: Int, oldScrollX: Int, oldScrollY: Int)
    }
    ...
    internal class AccessibilityDelegate : AccessibilityDelegateCompat()
    {
        override fun performAccessibilityAction(host: View, action: Int, arguments: Bundle): Boolean
        {
            ...
            val nsvHost = host as NewNestedScroll
